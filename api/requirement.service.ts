...
// @ts-ignore
import { RequirementProperty } from '../model/requirementProperty';
...
export class RequirementService {
    ...
    /**
     * Get properties of a requirement by requirement ID
     * Retrieves all properties associated with a specific requirement
     * @param requirementId The ID of the requirement
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public getRequirementProperties(requirementId: number, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<Array<RequirementProperty>>;
    public getRequirementProperties(requirementId: number, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<Array<RequirementProperty>>>;
    public getRequirementProperties(requirementId: number, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<Array<RequirementProperty>>>;
    public getRequirementProperties(requirementId: number, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        if (requirementId === null || requirementId === undefined) {
            throw new Error('Required parameter requirementId was null or undefined when calling getRequirementProperties.');
        }
        ...
        let localVarPath = `/requirement/${this.configuration.encodeParam({name: "requirementId", value: requirementId, in: "path", style: "simple", explode: false, dataType: "number", dataFormat: "int64"})}/properties`;
        return this.httpClient.request<Array<RequirementProperty>>('get', `${this.configuration.basePath}${localVarPath}`,
            {
                context: localVarHttpContext,
                responseType: <any>responseType_,
                withCredentials: this.configuration.withCredentials,
    ...
    /**
     * Get the requirement tree by requirementId
     * Get the requirement tree by requirementId
     * @param requirementId the parent requirement id
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    ...
    /**
     * Get the requirement tree by requirementId and level
     * Get the requirement tree by requirementId and level
     * @param requirementId the parent requirement id
     * @param level how many level get the requirement
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    ...
    public requirementTreeByIdAndLevel(requirementId: number, level: number, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        ...
        if (level === null || level === undefined) {
            throw new Error('Required parameter level was null or undefined when calling requirementTreeByIdAndLevel.');
        }
